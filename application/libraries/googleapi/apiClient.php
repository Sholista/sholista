...
require_once (APPPATH.'libraries/googleapi/config.php');
...
require_once (APPPATH.'libraries/googleapi/service/apiModel.php');
require_once (APPPATH.'libraries/googleapi/service/apiService.php');
require_once (APPPATH.'libraries/googleapi/service/apiServiceRequest.php');
require_once (APPPATH.'libraries/googleapi/auth/apiAuth.php');
require_once (APPPATH.'libraries/googleapi/cache/apiCache.php');
require_once (APPPATH.'libraries/googleapi/io/apiIO.php');
require_once (APPPATH.'libraries/googleapi/service/apiMediaFileUpload.php');
